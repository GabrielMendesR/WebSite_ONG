...
function getOngImagesTest() {
    axios.get('http://164.152.57.77:3000/api/ong/images')
    .then(response => {
...
function uploadImageTest() {
    ...
    axios.post('http://164.152.57.77:3000/api/ong/images', formData, {
        headers: {
...
function getOngsTest() {
    const token = localStorage.getItem('token');
    axios.get('http://164.152.57.77:3000/api/ong', {
        headers: {
...
async function cadastrar() {
    ...
    validateForm(formData).then(() => {
        axios.post('http://164.152.57.77:3000/api/ong', formData, {
            headers: {
                'Content-Type': 'multipart/form-data',
            }
        })
